...
/* harmony import */ var _src_hocs_WithReduxStore__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../src/hocs/WithReduxStore */ "./src/hocs/WithReduxStore.tsx");
/* harmony import */ var next_app__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! next/app */ "./node_modules/next/app.js");
/* harmony import */ var next_app__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(next_app__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var next_head__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! next/head */ "next/head");
/* harmony import */ var next_head__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(next_head__WEBPACK_IMPORTED_MODULE_5__);

var _jsxFileName = "/Users/raghavahuja/playground/next_ts/pages/_app.tsx";
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_src_hocs_WithReduxStore__WEBPACK_IMPORTED_MODULE_3__["default"])(MyApp));

/***/ }),

/***/ "./src/hocs/WithReduxStore.tsx":
/*!*************************************!*\
  !*** ./src/hocs/WithReduxStore.tsx ***!
  \*************************************/
/*! exports provided: default */
...
/* harmony import */ var _redux_config__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../redux/config */ "./src/redux/config/index.ts");
...
function getOrCreateStore(req, res) {
  ...
  if (isServer) {
    return Object(_redux_config__WEBPACK_IMPORTED_MODULE_5__["initializeStore"])(req, res);
  } // Client side store initialization


  if (!window['redux-store']) {
    window['redux-store'] = Object(_redux_config__WEBPACK_IMPORTED_MODULE_5__["initializeStore"])();
...
/* harmony default export */ __webpack_exports__["default"] = (Component => {
  ...
  return _temp = class AppWithRedux extends react__WEBPACK_IMPORTED_MODULE_4___default.a.Component {
    static async getInitialProps(appContext) {
      ...
      let appProps = {};
      await new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_2___default.a((resolve, reject) => {
        let {
          bootstrapped
    ...
    constructor(props) {
      ...
      Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3__["default"])(this, "reduxStore", void 0);

      Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3__["default"])(this, "persistor", void 0);
...
function initializeStore(req, res) {
  ...
  const store = Object(redux__WEBPACK_IMPORTED_MODULE_0__["createStore"])( // combineReducers<StoreState>({ user: userReducer })
  rootReducer);
...
/***/ "./src/utils/helpers/customCookieStorage.ts":
/*!**************************************************!*\
  !*** ./src/utils/helpers/customCookieStorage.ts ***!
  \**************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CustomCookieStorage; });
/* harmony import */ var redux_persist_cookie_storage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! redux-persist-cookie-storage */ "redux-persist-cookie-storage");
/* harmony import */ var redux_persist_cookie_storage__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(redux_persist_cookie_storage__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var cookies_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! cookies-js */ "cookies-js");
...
/* harmony import */ var _nodeCookieWrapper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./nodeCookieWrapper */ "./src/utils/helpers/nodeCookieWrapper.js");
...
function CustomCookieStorage(req, res) {
  let cookieStorage;

  if (true) {
    if (!req) {
      console.warn("request object is required in ssr store initalization");
      cookieStorage = redux_persist_lib_storage__WEBPACK_IMPORTED_MODULE_4___default.a;
    } else {
      const cookieJar = new _nodeCookieWrapper__WEBPACK_IMPORTED_MODULE_3__["default"](cookies__WEBPACK_IMPORTED_MODULE_2___default()(req, res));
      cookieStorage = new redux_persist_cookie_storage__WEBPACK_IMPORTED_MODULE_0__["CookieStorage"](cookieJar);
    }
  } else {}
...
/***/ "./src/utils/helpers/nodeCookieWrapper.js":
/*!************************************************!*\
  !*** ./src/utils/helpers/nodeCookieWrapper.js ***!
  \************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (NodeCookiesWrapper);
